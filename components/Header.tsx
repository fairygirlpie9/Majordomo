...
const Header: React.FC<HeaderProps> = ({ theme, toggleTheme, tempUnit, toggleTempUnit, activeProperty, currentTime, toggleSidebar }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 h-24 flex items-center justify-between">
        
        {/* Left Side: Logo & Status */}
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-[#FCA311] rounded-xl flex items-center justify-center shadow-lg shadow-[#FCA311]/20">
              <Shield className="text-[#000000] w-7 h-7" />
            </div>
            <div className="hidden sm:block">
              <h1 className={`text-2xl font-serif-display font-medium leading-none ${isDark ? 'text-[#E5E5E5]' : 'text-[#000000]'}`}>
                Majordomo
              </h1>
        ...
        <div className="flex items-center gap-5 sm:gap-8">
          <div className="hidden sm:flex items-center gap-4 pr-8 border-r border-current border-opacity-10">
          ...
          <button 
            ...
            className={`w-11 h-11 flex items-center justify-center rounded-full text-base font-bold transition-colors border ${
          ...
          <button className={`relative p-3 rounded-full transition-colors ${
              isDark ? 'hover:bg-[#E5E5E5]/10 text-[#E5E5E5]' : 'hover:bg-[#000000]/5 text-[#000000]'
            }`}>
            <Bell size={24} />
          ...
          <div className="flex items-center gap-4 ml-2 pl-6 border-l border-current border-opacity-10">
