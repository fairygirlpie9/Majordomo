      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm sm:text-base mt-2 opacity-50 font-medium tracking-wide">Feels like {displayFeelsLike}°</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-5">
          <div className={`p-4 sm:p-5 rounded-3xl flex flex-col items-center justify-center text-center ${isDark ? 'bg-[#E5E5E5]/5' : 'bg-[#000000]/5'}`}>
            <div className="flex items-center gap-2 mb-3 opacity-50">
              <Wind size={18} />
              <span className="text-[10px] sm:text-xs uppercase font-bold tracking-wider">Wind</span>
            </div>
          ...
          <div className={`p-4 sm:p-5 rounded-3xl flex flex-col items-center justify-center text-center ${isDark ? 'bg-[#E5E5E5]/5' : 'bg-[#000000]/5'}`}>
            <div className="flex items-center gap-2 mb-3 opacity-50">
              <Droplets size={18} />
              <span className="text-[10px] sm:text-xs uppercase font-bold tracking-wider">Humidity</span>
            </div>
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs font-medium">06:42 AM</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 text-right">
            <div>
              ...
              <p className="text-xs font-medium">08:14 PM</p>
            </div>
